...
public class InvTest {
	...
	@Test
	public void shouldPerformInvertsWhenStackHasOneElement() {
		//Given
		...
		assertThat(results.get(0), is(equalTo(new BigDecimal("0.2"))));
		...
		assertThat(records.get(0).getOperator(), is(instanceOf(Inv.class)));
